...
void sdl_show_points(int points);

/**
 * Draws all bodies in the scene of a game.
 * This internally calls sdl_render_scene.
 *
 * @param game the gane with the scene to draw
 */
...
void sdl_free_noise(Mix_Chunk *noise);

SDL_Texture *sdl_create_pic(char *f, vector_t pos, double scaling);
