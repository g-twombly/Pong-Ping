...
/**
 * Returns a normalized version of the vector (not modifying in place).
 *
...
/**
 * Returns the magnitude of a vector (not modifying in place).
 *
 * @param v1 the vector whose magnitude we need
 * @return the magnitude
 */
double vec_magnitude(vector_t v);

/**
 * Returns a deepcopied version of the vector
 *
...
/**
 * Returns whether two vectors representing intervals overlap.
 *
 * @param v1 the first vector
 * @param v2 the second vector
...
/**
 * Given two vectors overlap, return its overlap.
 *
 * @param v1 the first vector
 * @param v2 the second vector
