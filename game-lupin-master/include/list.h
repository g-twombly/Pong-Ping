...
/**
 * A function that can be called on list elements to copy their data.
 */
...
/**
 * Returns whether a list constains a specific value.
 *
 * @param list the list
 * @param val the value
 * @return whether the list contains val
 */
...
/**
 * Removes the last in a list and returns it.
...
/**
 * Creates a deepcopy of a given list
 *
 * @param og the list to make a deepcopy of
 * @param copy if non-NULL, a function to call on elements in the list
 *   to deep copy
 * @return a pointer to the newly allocated list
 */
